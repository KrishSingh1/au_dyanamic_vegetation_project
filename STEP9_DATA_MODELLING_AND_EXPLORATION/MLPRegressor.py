# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 16:16:53 2024
...
hyp_params = { 
    'hidden_layer_sizes': [[10,10,10,10], [40]],
    'max_iter': [100000],
...
Tuned_RF_CV = pd.DataFrame(cross_validate(MLPRegressor(**grid.best_params_), X = train[FEATURES],
                     y = train[TARGET], cv=tss, 
                     scoring=np.unique(['r2', main_scorer]).tolist(),
                     return_train_score = True))
