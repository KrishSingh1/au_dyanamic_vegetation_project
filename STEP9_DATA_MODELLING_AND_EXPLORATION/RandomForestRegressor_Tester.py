...
print(f'Default CV\nTrain MSE {default_RF_CV["train_" + "neg_mean_squared_error"].mean()}\nTest MSE {default_RF_CV["test_" + "neg_mean_squared_error"].mean()}')
...
print(f'Tuned CV\nTrain MSE {Tuned_RF_CV["train_" + "neg_mean_squared_error"].mean()}\nTest MSE {Tuned_RF_CV["test_" + "neg_mean_squared_error"].mean()}')
