...
datasets_simulated = pd.concat(datasets).dropna(subset = FEATURES)
datasets_simulated.sort_values('time', inplace = True)
datasets_simulated.set_index('time', inplace = True)
