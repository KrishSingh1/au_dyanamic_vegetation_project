...
# https://digital.atlas.gov.au/datasets/db9ae2c1d2374e20b60f26c45118f6f3_0/explore?location=-21.892570%2C134.777077%2C4.50
...
kmz_data <- st_read("../AusPlots_Location/Derived_Boundary_Polygons/AusPlots_Polygons_from_Published_Plots.shp", quiet = TRUE) # get polygons from ausplots sites 
...
write.csv(result_list_csv, '../AusPlots_FireDates/AusPlots_Historical_BurnDates.csv')
