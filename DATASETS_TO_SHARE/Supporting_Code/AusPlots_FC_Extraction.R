...
sites <- read.csv("../Site_Info/extracted_Final_site_info_2-0-6.csv")
site.names <- unique(sites$site.info.site_location_name)
fcs <- get_individual_fcs(site.names)

write.csv(fcs,'../AusPlots_FC/AusPlots_Extracted_Data/Final/AusPlots_FC_Iter_2_0_6.csv')
...
write.csv(fcs.sub,'../AusPlots_FC/AusPlots_Sub_FC_Iter_2_0_6.csv')
