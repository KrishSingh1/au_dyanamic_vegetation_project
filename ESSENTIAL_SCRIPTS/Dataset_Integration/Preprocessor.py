...
#C:\Users\krish\Desktop\DYNAMIC MODEL VEGETATION PROJECT\au_dyanamic_vegetation_project\DATASETS\DEM_Data

twi_aspect = pd.read_csv('C:/Users/krish/Desktop/DYNAMIC MODEL VEGETATION PROJECT/au_dyanamic_vegetation_project/DATASETS/DEM_Data/DEM_Aspect_TWI.csv', index_col = 0) # vegetation cover data
twi_aspect_selector = ['aspect_1s', 'twi_1s'] # the soil attributes to include
...
for site_location_name in sites_list:
    ...
    site_DEM_attributes = twi_aspect[twi_aspect.index == site_location_name]
    ...
    time_fc_pipeline = Pipeline([
        ...
        ('DEM_atributes_adder',
         DEM_atributes_adder(site_DEM_attributes, twi_aspect_selector))
         ])
