...
extract_script="/home/-/jk8585/misc/extract_climate_vars.sh"  # name of script that extracts climate variables for one site
sitelist="/home/599/-/misc/sites_info_query_latlon.csv"    # site list including site name, latitude, and longitude
